...
sudo taskset -c 1 ./meminterf -v --size=156 --iterations=855 --test=memset & PID_TO_WAIT=$!
sudo taskset -c 2 ./meminterf -v --size=156 --iterations=855 --test=memset & PID_TO_WAIT=$!
sudo taskset -c 3 ./meminterf -v --size=156 --iterations=855 --test=memset & PID_TO_WAIT=$!
