...
do 
	...
	python3 splitftrace.py trace_memset_$i.txt

	echo "done"
	sleep 10
done 

mv *.txt tests_staticThrottleMemset 
...
do 
	...
	python3 splitftrace.py trace_memcpy_$i.txt

	echo "done"
	sleep 10
done 

mv *.txt tests_staticThrottleMemcpy
