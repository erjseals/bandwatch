...
mkdir -p disparity_memset_static_throttle
mkdir -p disparity_memcpy_static_throttle
...
do 
	...
	sudo taskset -c 0 ../../benchmarks/sd-vbs/benchmarks/disparity/data/fullhd/disparity ../../benchmarks/sd-vbs/benchmarks/disparity/data/fullhd/. | grep "Cycles elapsed" >> cycles_memset_$i.txt & PID_TO_WAIT=$! 
	wait $PID_TO_WAIT
	sudo rmmod memguard
...
mv *.txt disparity_memset_static_throttle 
...
do 
	...
	sudo taskset -c 0 ../../benchmarks/sd-vbs/benchmarks/disparity/data/fullhd/disparity ../../benchmarks/sd-vbs/benchmarks/disparity/data/fullhd/. | grep "Cycles elapsed" >> cycles_memcpy_$i.txt & PID_TO_WAIT=$! 
	wait $PID_TO_WAIT
	sudo rmmod memguard
...
mv *.txt disparity_memcpy_static_throttle
