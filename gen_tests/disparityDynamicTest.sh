...
sudo taskset -c 0 ../benchmarks/sd-vbs/benchmarks/disparity/data/fullhd/disparity ../benchmarks/sd-vbs/benchmarks/disparity/data/fullhd/. | grep "Cycles elapsed" >> cycles_dynamic_memcpy.txt & PID_TO_WAIT=$! 
wait $PID_TO_WAIT
